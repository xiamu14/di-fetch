...
type CodeKeys = keyof typeof STATUS_CODES;

export class HTTPErrors extends Error {
  statusCode: CodeKeys;
  explain: string;
  extras?: unknown;
  constructor(code: CodeKeys, message: string, extras?: unknown) {
    super(message);
    this.explain = STATUS_CODES[code];
    this.extras = extras;
    this.statusCode = code;
  }
}

export function isHTTPErrors(error: unknown): error is HTTPErrors {
