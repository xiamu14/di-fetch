...
export const uploadFile = (
  ...
  return fetchTransit<ApiResponse>({
 ...
 */
export const addPet = (petBody: BodyType<PetBody>) => {
 ...
 */
export const updatePet = (petBody: BodyType<PetBody>) => {
  return fetchTransit<unknown>({
    url: `/pet`,
    method: "put",
    headers: { "Content-Type": "application/json" },
 ...
 * @summary Finds Pets by status
 */
export const useFindPetsByStatus = <TError = ErrorType<void>>(
...
export const findPetsByTags = (params: FindPetsByTagsParams) => {
  return fetchTransit<Pet[]>({ url: `/pet/findByTags`, method: "get", params });
};
 ...
 * @summary Finds Pets by tags
 */
export const useFindPetsByTags = <TError = ErrorType<void>>(
...
export const getPetById = (petId: number) => {
  return fetchTransit<Pet>({ url: `/pet/${petId}`, method: "get" });
};
...
export const deletePet = (petId: number) => {
  return fetchTransit<unknown>({ url: `/pet/${petId}`, method: "delete" });
};
